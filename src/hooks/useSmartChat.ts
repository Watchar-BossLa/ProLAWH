  ...
  useEffect(() => {
    ...
    const mockHistory: Message[] = [
      ...
      },
      {
        id: '3',
        sender: 'user',
        content: 'I\'ve been making good progress. The search functionality is almost complete and the UI is looking great.',
        timestamp: new Date(Date.now() - 72000000).toISOString() // 20 hours ago
      },
      {
        id: '4',
        sender: 'contact',
        content: 'That sounds amazing! Would love to see a demo when you\'re ready. Have you considered implementing real-time updates for the search results?',
        timestamp: new Date(Date.now() - 68400000).toISOString() // 19 hours ago
      },
      {
        id: '5',
        sender: 'user',
        content: 'Actually, that\'s a great idea. I\'ll add it to my backlog and look into WebSocket integration for the real-time updates.',
