-- Fix critical security vulnerabilities for existing tables

-- 1. Fix role escalation vulnerability - restrict user_roles management
...
-- 3. Add security audit logging for failed auth attempts
